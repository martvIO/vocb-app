...
> Knowledge base for the **vocb-app** project — a cross-platform (iPad, macOS, Windows) vocabulary-learning app. Captures architecture, the Firebase + Claude backend, the native Apple and Windows clients, the shared data model, and key decisions.
